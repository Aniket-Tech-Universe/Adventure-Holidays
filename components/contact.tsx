import { MapPin, Phone, Clock, Send, Accessibility, Heart, Globe, Plane, CheckCircle2, Sparkles } from "lucide-react";
            ...
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative glass-card rounded-2xl p-6 lg:p-8 border-white/10 hover:border-cyan-500/20 transition-colors">
                            ...
                            <form className="space-y-5">
                                ...
                                <button
                                    type="submit"
                                    className="w-full relative group overflow-hidden px-6 py-4 rounded-xl bg-gradient-to-r from-cyan-500 to-cyan-600 text-white font-semibold shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all duration-300"
                                >
